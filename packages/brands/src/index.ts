...
export const brands: Record<BrandId, Brand> = {
  surroundshow: {
    ...
    nav: [
      ...
      { label: "HomeShow", href: "/homeshow" },
      { label: "Ceremony", href: "/wedding-ceremony" },
    ...
    showTags: [
      { tag: "homeshow", label: "HomeShow", blurb: "Holiday house shows — Christmas, Halloween, New Year and the rest of the year." },
      ...
      { tag: "weddingceremony", label: "Wedding Ceremony", blurb: "Immersive chapel — wrap-around theme, aisle, vows, rings, first dance." },
      { tag: "weddingreception", label: "Wedding Reception", blurb: "DJ music list with speech, dance, and game interludes." },
      { tag: "barloco", label: "Bar Loco", blurb: "Christmas pop-up bar — doors, carols, games, Bad Elf, last call." },
    ],
  ...
  funfirst: {
    ...
    showTags: [
      ...
      { tag: "laffup", label: "LaffUp", blurb: "Open-mic stand-up showcases, run as a set list." },
      { tag: "thisgameshow", label: "This Game Show", blurb: "Classic studio game show — Contestants vs Champions, scored games, audience vote, prize reveal." },
