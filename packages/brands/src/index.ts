...
export const brands: Record<BrandId, Brand> = {
  surroundshow: {
    ...
    showTags: [
      ...
      { tag: "weddingloco", label: "Wedding Loco", blurb: "Reception set lists - entrance to send-off." },
      { tag: "barloco", label: "Bar Loco", blurb: "Bar night set lists - doors to last call." },
    ],
