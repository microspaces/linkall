...
export const brands: Record<BrandId, Brand> = {
  ...
  funfirst: {
    ...
    showTags: [
      ...
      { tag: "headcase", label: "HeadCase", blurb: "AI-assisted comedy bits and sketches — Humans vs Bots." },
      { tag: "wwcce", label: "WWCCE", blurb: "Wrestling comedy championship extravaganza." },
      { tag: "laffup", label: "LaffUp", blurb: "Open-mic stand-up showcases — Openers vs Headliners." },
    ],
