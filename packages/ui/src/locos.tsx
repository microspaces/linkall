...
/**
 * Hub of FunFirst loco formats. Each card links to that loco's performances,
 * console, and games catalog.
 */
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-gray-500">
        Comedy Loco, Battle Loco, Wrestle Loco, HeadCase, and LaffUp — open a
        format to run its performances.
      </p>
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="mt-2 text-xs text-gray-400">
                  {loco.team1} vs {loco.team2} · {loco.templateRounds.length}{" "}
                  rounds
                </p>
