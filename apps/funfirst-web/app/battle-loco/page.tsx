import BattleLocoClient from "./BattleLocoClient";
import "./battle-loco.css";

export default function BattleLocoPage() {
  const year = new Date().getFullYear();

  return (
    <div className="bl-page bl-body">
        ...
        <section className="hero" aria-labelledby="hero-heading">
          <div className="hero__media">
            ...
            <img
              ...
              alt="Packed Hyperex Arena under neon blue and pink lights with a roaring Las Vegas crowd"
              width={1920}
              height={1080}
              fetchPriority="high"
            />
          ...
          <div className="hero__content mx-auto flex min-h-[100svh] max-w-6xl flex-col justify-end px-5 pb-16 pt-32 md:justify-center md:px-8 md:pb-24 md:pt-28">
            ...
            <p className="hero__tagline reveal reveal-delay-2">
              Esports. Chaos. Crowd control.<br className="hidden sm:block" />
              The live show Vegas wasn&apos;t ready for.
            </p>

            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center reveal reveal-delay-3">
              <a href="#waitlist" className="btn btn-blue btn-lg">Join the Waitlist</a>
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-10 px-5 md:grid-cols-2 md:gap-14 md:px-8">
            <div className="order-2 md:order-1">
              ...
              <p className="mt-5 max-w-xl text-base leading-relaxed text-white/70 md:text-lg">
                YouTubers, celebrities, and athletes go head-to-head in a live Vegas showdown —
                video games one round, Minute to Win It–style mayhem the next. Win glory.
                Lose… and take the punishment. The crowd doesn&apos;t just watch. They run the show.
              </p>
              <ul className="feature-list mt-8">
                <li>
                  <span className="feature-list__icon feature-list__icon--blue" aria-hidden="true" />
                  Gaming + physical / mental challenges every night
                </li>
                <li>
                  <span className="feature-list__icon feature-list__icon--pink" aria-hidden="true" />
                  Fun punishments, wild rewards, Savannah Bananas–level silliness
                </li>
                <li>
                  <span className="feature-list__icon feature-list__icon--green" aria-hidden="true" />
                  Live phone voting that actually changes the action
                </li>
              </ul>
            </div>
            ...
            <div className="order-1 md:order-2">
              <figure className="media-frame media-frame--tilt">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="/battle-loco/images/competitors.jpg"
                  alt="Competitors reacting mid-challenge under hot pink and electric blue stage lights"
                  width={1600}
                  height={900}
                  loading="lazy"
                />
          ...
          <div className="mx-auto max-w-6xl px-5 md:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <h2 id="experience-heading" className="section-title">
                Built for the crowd that refuses to sit still
              </h2>
              <p className="mt-4 text-base text-white/65 md:text-lg">
                Think tournament intensity meets late-night Vegas spectacle —
                and you&apos;re part of the cast.
              </p>
            </div>
            ...
            <div className="experience-grid mt-12">
              <article className="xp-item">
                ...
                <h3 className="xp-item__title">Multi-Round Mayhem</h3>
                <p className="xp-item__text">
                  Controllers down, then ping-pong balls flying. Every round flips the vibe —
                  skill, speed, and pure chaos in rotation.
                </p>
              </article>
              <article className="xp-item">
                ...
                <p className="xp-item__text">
                  Vote live. Trigger on-screen challenges. Twist the match mid-play.
                  Your seat is a controller.
                </p>
              </article>
              <article className="xp-item">
            ...
            <figure className="media-frame media-frame--wide mt-14">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="/battle-loco/images/crowd.jpg"
                alt="Arena crowd holding glowing phones towards a massive neon LED stage screen"
                width={1600}
                height={900}
                loading="lazy"
              />
              <figcaption className="media-caption">
                The crowd doesn&apos;t clap politely. They hijack the show.
              </figcaption>
            </figure>
          </div>
        </section>
            ...
            <div className="waitlist-panel">
              ...
              <div className="relative z-10 mx-auto max-w-xl text-center">
                ...
                <p className="mt-4 text-base text-white/70 md:text-lg">
                  Jump the list for Battle Loco updates, ticket drops, and early access
                  before the arena sells out of seats — and sanity.
                </p>
              </div>
              ...
              <form id="waitlist-form" className="waitlist-form relative z-10" noValidate>
                ...
                <button type="submit" className="btn btn-blue btn-lg w-full sm:w-auto" id="submit-btn">
                ...
                <div id="form-success" className="form-success" role="status" hidden>
                  ...
                  <p className="form-success__text">
                    When Battle Loco drops dates and tickets, you&apos;ll hear it first.
                    Stay loco.
                  </p>
                </div>
              </form>
      ...
      <footer className="site-footer">
        <div className="mx-auto flex max-w-6xl flex-col gap-6 px-5 py-10 md:flex-row md:items-center md:justify-between md:px-8">
          <div>
            <a href="#top" className="brand-mark brand-mark--sm" aria-label="Battle Loco home">
              <span className="brand-mark__battle">Battle</span>
              <span className="brand-mark__loco">Loco</span>
            </a>
          ...
          <div className="flex flex-wrap items-center gap-5 text-sm text-white/55">
            ...
            <a href="mailto:hello@battleloco.com" className="footer-link">Contact</a>
          ...
          <p className="text-xs text-white/35 md:text-right">
            © {year} Battle Loco. All rights reserved.
          </p>
        </div>
      </footer>
